...
export default function Page() {
    return <TopLevelContainer>
      <p>I have put a current version of my <Link className="" href={`/resume`}>Resume</Link> on the site and have begun adding my <Link className="" href={`/portfolio`}>Project history</Link>.</p>  
      <p></p>
